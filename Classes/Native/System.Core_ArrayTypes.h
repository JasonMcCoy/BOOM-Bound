...
#include "System_Core_System_Collections_Generic_HashSet_1_Li120620512.h"
#include "System_Core_System_Collections_Generic_HashSet_1_L1079658477.h"
...
struct LinkU5BU5D_t402278049  : public Il2CppArray
{
public:
	ALIGN_FIELD (8) Link_t120620512  m_Items[1];

public:
	inline Link_t120620512  GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline Link_t120620512 * GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, Link_t120620512  value)
	{
		m_Items[index] = value;
	}
};
// System.Collections.Generic.HashSet`1/Link<UnityEngine.Purchasing.Product>[]
struct LinkU5BU5D_t1479639488  : public Il2CppArray
{
public:
	ALIGN_FIELD (8) Link_t1079658477  m_Items[1];

public:
	inline Link_t1079658477  GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline Link_t1079658477 * GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, Link_t1079658477  value)
	{
		m_Items[index] = value;
	}
};
