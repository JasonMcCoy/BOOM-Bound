...
extern "C"  float TrailRenderer_get_time_m3171495838 (TrailRenderer_t2401074527 * __this, const MethodInfo* method)
{
	typedef float (*TrailRenderer_get_time_m3171495838_ftn) (TrailRenderer_t2401074527 *);
...
extern "C"  void TrailRenderer_set_time_m622215629 (TrailRenderer_t2401074527 * __this, float ___value0, const MethodInfo* method)
{
	typedef void (*TrailRenderer_set_time_m622215629_ftn) (TrailRenderer_t2401074527 *, float);
...
extern "C"  float TrailRenderer_get_startWidth_m2156471701 (TrailRenderer_t2401074527 * __this, const MethodInfo* method)
{
	typedef float (*TrailRenderer_get_startWidth_m2156471701_ftn) (TrailRenderer_t2401074527 *);
...
extern "C"  void TrailRenderer_set_startWidth_m4193695030 (TrailRenderer_t2401074527 * __this, float ___value0, const MethodInfo* method)
{
	typedef void (*TrailRenderer_set_startWidth_m4193695030_ftn) (TrailRenderer_t2401074527 *, float);
...
extern "C"  float TrailRenderer_get_endWidth_m728996604 (TrailRenderer_t2401074527 * __this, const MethodInfo* method)
{
	typedef float (*TrailRenderer_get_endWidth_m728996604_ftn) (TrailRenderer_t2401074527 *);
...
extern "C"  void TrailRenderer_set_endWidth_m3015327535 (TrailRenderer_t2401074527 * __this, float ___value0, const MethodInfo* method)
{
	typedef void (*TrailRenderer_set_endWidth_m3015327535_ftn) (TrailRenderer_t2401074527 *, float);
...
extern "C"  float Vector4_get_magnitude_m4287880729 (Vector4_t4282066567 * __this, const MethodInfo* method)
{
	static bool s_Il2CppMethodIntialized;
	if (!s_Il2CppMethodIntialized)
	{
...
extern "C"  float Vector4_get_magnitude_m4287880729_AdjustorThunk (Il2CppObject * __this, const MethodInfo* method)
{
	Vector4_t4282066567 * _thisAdjusted = reinterpret_cast<Vector4_t4282066567 *>(__this + 1);
	return Vector4_get_magnitude_m4287880729(_thisAdjusted, method);
}
...
extern "C"  Vector4_t4282066567  Vector4_op_Addition_m217826897 (Il2CppObject * __this /* static, unused */, Vector4_t4282066567  ___a0, Vector4_t4282066567  ___b1, const MethodInfo* method)
{
	{
		float L_0 = (&___a0)->get_x_1();
		float L_1 = (&___b1)->get_x_1();
...
IL_0081:
		{
			...
			int32_t L_31 = V_7;
			NullCheck(L_30);
			String_t* L_32 = List_1_get_Item_m3285151025(L_30, L_31, /*hidden argument*/List_1_get_Item_m3285151025_MethodInfo_var);
			NullCheck(L_29);
			...
			int32_t L_46 = V_7;
			NullCheck(L_45);
			String_t* L_47 = List_1_get_Item_m3285151025(L_45, L_46, /*hidden argument*/List_1_get_Item_m3285151025_MethodInfo_var);
			V_10 = L_47;
			String_t* L_48 = V_10;
...
IL_017d:
		{
			...
			int32_t L_73 = V_7;
			NullCheck(L_72);
			String_t* L_74 = List_1_get_Item_m3285151025(L_72, L_73, /*hidden argument*/List_1_get_Item_m3285151025_MethodInfo_var);
			if (!L_74)
			{
				goto IL_025c;
			}
...
IL_01b9:
		{
			...
			int32_t L_76 = V_7;
			NullCheck(L_75);
			String_t* L_77 = List_1_get_Item_m3285151025(L_75, L_76, /*hidden argument*/List_1_get_Item_m3285151025_MethodInfo_var);
			V_12 = L_77;
			String_t* L_78 = V_12;
			IL2CPP_RUNTIME_CLASS_INIT(Encoding_t2012439129_il2cpp_TypeInfo_var);
...
IL_0347:
		{
			...
			int32_t L_147 = V_18;
			NullCheck(L_146);
			String_t* L_148 = List_1_get_Item_m3285151025(L_146, L_147, /*hidden argument*/List_1_get_Item_m3285151025_MethodInfo_var);
			NullCheck(L_145);
